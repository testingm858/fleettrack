...
CREATE TABLE "new_User" (
    ...
    "unitPrefsJson" TEXT NOT NULL DEFAULT '{}',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "User_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES "Driver" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_User" ("createdAt", "driverId", "email", "id", "name", "passwordHash", "role") SELECT "createdAt", "driverId", "email", "id", "name", "passwordHash", "role" FROM "User";
DROP TABLE "User";
